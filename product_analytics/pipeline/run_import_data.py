...
from product_analytics.ingest.import_catalog_items_from_excel import import_catalog_items_from_excel
from product_analytics.ingest.import_product_metrics_daily_from_excel import import_product_metrics_daily


def product_import():
    # 示例：本月

    EXCEL_PATH = r"D:\TB\product_analytics\input_data\product_info\商品统计_20251230.xlsx"
    ...
    # EXCEL_PATH = r"D:\TB\product_analytics\input_data\daily_metrics\252507.xlsx"
