...
CLARKS = {
    ...
    "ORG_IMAGE_DIR": CLARKS_BASE / "document" / "orgin_images",
    "DEF_IMAGE_DIR": CLARKS_BASE / "document" / "DEF_images",
    ...
    "HTML_CUTTER_DES": CLARKS_BASE / "document" / "html_cutter"/ "description",
    "HTML_CUTTER_FIRST_PAGE": CLARKS_BASE / "document" / "html_cutter"/ "first_page",
