...
CAMPER = {
    ...
    "HTML_CUTTER_DES": CAMPER_BASE / "publication" / "html_cutter"/ "description",
    "HTML_CUTTER_FIRST_PAGE": CAMPER_BASE / "publication" / "html_cutter"/ "first_page",
    "STORE_DIR": CAMPER_BASE / "publication" / "store",
