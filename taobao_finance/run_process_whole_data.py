...
# 步骤 1：淘宝后台导出的订单 Excel，可多个（按月分开下载的都列在这里）
TAOBAO_EXCELS = [
    r"D:\TB\淘宝会计统计数据\202506\五小剑\淘宝交易记录\ExportOrderList202607300102.csv",
    # r"D:\TB\淘宝会计统计数据\202603\五小剑\淘宝交易记录\ExportOrderList202604090741.csv",
    # r"D:\OneDrive\Documentation\淘宝会计统计数据\ExportOrderList_202511.xlsx",
]

# 步骤 2：鲸芽后台导出的分销数据 Excel（含分销利润）
JINGYA_EXCEL = r"D:\TB\淘宝会计统计数据\202506\五小剑\鲸芽交易记录\jingya_202509.xlsx"

# 步骤 3：税务局推送的申报 Excel，每个季度通常 3 个月
# 格式：(输入路径, 输出路径)
TAX_EXCELS = [
    (
        r"D:\TB\淘宝会计统计数据\202506\五小剑\淘宝财务数据\交易货款_202504_202504.csv",
        r"D:\TB\淘宝会计统计数据\202506\五小剑\淘宝财务数据\交易货款_202504_202504_enriched.xlsx",
    ),
    (
        r"D:\TB\淘宝会计统计数据\202506\五小剑\淘宝财务数据\交易货款_202505_202505.csv",
        r"D:\TB\淘宝会计统计数据\202506\五小剑\淘宝财务数据\交易货款_202505_202505_enriched.xlsx",
    ),
    (
        r"D:\TB\淘宝会计统计数据\202506\五小剑\淘宝财务数据\交易货款_202506_202506.csv",
        r"D:\TB\淘宝会计统计数据\202506\五小剑\淘宝财务数据\交易货款_202506_202506_enriched.xlsx",
    ),
]
