...
CATEGORY_MAP = {
    ...
    "jacket":    ("夹克外套", ["英伦","修身","防风","轻盈","挺括","有里衬","通勤","百搭"]),
    "jackets":   ("夹克外套", ["英伦","修身","防风","轻盈","挺括","有里衬","通勤","百搭"]),
    "coat":      ("夹克外套", ["英伦","保暖","修身","防风","挺括","有里衬","通勤","百搭"]),
    "coats":     ("夹克外套", ["英伦","保暖","修身","防风","挺括","有里衬","通勤","百搭"]),
    "sweatshirt":  ("卫衣", ["宽松","百搭","休闲","软糯","亲肤","加绒","舒适"]),
    "sweatshirts": ("卫衣", ["宽松","百搭","休闲","软糯","亲肤","加绒","舒适"]),
    "lingerie": ("内衣", ["亲肤","柔软","舒适","透气","无钢圈","包裹"]),
    "shorts":   ("短裤", ["显腿长","高腰","宽松","修身","百搭","通勤"]),
}
