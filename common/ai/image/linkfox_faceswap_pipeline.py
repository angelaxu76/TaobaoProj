...
import os
import requests
from cfg.ai_config import IMAGE_EXT
...
def process_one_linkfox(
    ...
    *,
    ...
    注：gen_ori_res / real_model / output_num 默认 None（不传该字段），
    详见 LinkFoxClient.submit() 的说明。
