...
def main():
    ...
    print("下载指定商品编码的的图片")
    download_images_from_codes(r"D:\TB\Products\camper\repulibcation\missing_image_codes.txt")
    ...
    print("生成产品详情卡图片")
    process_html_folder(CAMPER["HTML_DIR_DES"], CAMPER["HTML_IMAGE_DES"])
    trim_sides_batch(CAMPER["HTML_IMAGE_DES"],CAMPER["HTML_CUTTER_DES"])

    print("生成产品首页图片")
    process_html_folder(CAMPER["HTML_DIR_FIRST_PAGE"], CAMPER["HTML_IMAGE_FIRST_PAGE"])
