...
from brands.clarks.helpers_local.GetProductURLs import get_regular_product_links
from brands.clarks.helpers_local.GetOutletProductURL import get_outlet_product_links
