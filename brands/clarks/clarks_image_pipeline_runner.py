...
def main():
    ...
    print("图抖动加上水平翻转")
    # batch_process_images(CLARKS["IMAGE_DIR"],CLARKS["IMAGE_TEMP"])




    print("最大化灰度裁剪图片")
    output_dir = Path(r"D:\TB\Products\clarks\repulibcation\五小剑\missing_Images")
    bg_color = (240, 240, 240)
    tolerance = 35
    quality = 85

    run_crop_and_expand(CLARKS["IMAGE_TEMP"], output_dir, bg_color, tolerance, quality)
