...
# 原始图片目录
source_dir = r"D:\TB\Products\barbour\repulibcation.20260916\linkfox_processed"

# 目标根目录（可以修改为其他路径）
target_root_dir = r"D:\TB\Products\barbour\repulibcation.20260916\linkfox_processed分组图片"
