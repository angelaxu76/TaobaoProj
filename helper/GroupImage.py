...
# 原始图片目录
source_dir = r"D:\TB\Products\clarks_jingya\publication\image_cutter_reduceSize"

# 目标根目录（可以修改为其他路径）
target_root_dir = r"D:\TB\Products\clarks_jingya\publication\image_cutter_reduceSize分组图片"
