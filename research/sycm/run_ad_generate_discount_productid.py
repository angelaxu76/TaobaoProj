...
def generate_discouted_product():
    ...
    #     output_txt_dir=r"D:\TB\Products\camper\repulibcation\store_prices\ztc_txt_out",
    #     only_in_stock=True,
    # )
    ...
    #     output_txt_dir=r"D:\TB\Products\geox\repulibcation\store_prices\ztc_txt_out",
    #     only_in_stock=True,
    # )
    ...
    #     output_txt_dir=r"D:\TB\Products\clarks_jingya\repulibcation\store_prices\ztc_txt_out",
    #     only_in_stock=True,
    # )
    ...
    export_discount_itemids_to_ztc_txts(
        ...
        output_txt_dir=r"D:\TB\Products\ecco\repulibcation\store_prices\ztc_txt_out",
        only_in_stock=True,
    )
